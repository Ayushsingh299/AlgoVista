...
[![GitHub contributors](https://img.shields.io/github/contributors/AlgoVista/AlgoVista.svg?style=flat-square)](https://github.com/AlgoVista/AlgoVista/graphs/contributors)
[![GitHub license](https://img.shields.io/github/license/AlgoVista/AlgoVista.svg?style=flat-square)](https://github.com/AlgoVista/AlgoVista/blob/master/LICENSE)
...
## algorithms
In this repository, you'll find visualizations of algorithms showcased in the website's side menu. Contributions here directly impact the educational content available on the platform.   https://github.com/AlgoVista/algorithms</li>
</ul>
...
[**algorithm-visualizer.org**![Screenshot](https://raw.githubusercontent.com/AlgoVista/AlgoVista/master/branding/screenshot.png)](https://AlgoVista.org/)
...
- [**`algorithm-visualizer`**](https://github.com/AlgoVista/AlgoVista) is a web app written in React. It contains UI components and interprets commands into visualizations. Check out [the contributing guidelines](CONTRIBUTING.md).

- [**`server`**](https://github.com/AlgoVista/server) serves the web app and provides APIs that it needs on the fly. (e.g., GitHub sign in, compiling/running code, etc.)

- [**`algorithms`**](https://github.com/AlgoVista/algorithms) contains visualizations of algorithms shown on the side menu of the website.
